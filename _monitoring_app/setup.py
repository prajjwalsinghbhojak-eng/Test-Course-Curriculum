...
Usage:
  python _monitoring_app/setup.py   # Windows / any platform
  bash _monitoring_app/setup.sh     # macOS / Linux shortcut
"""
...
def main():
    ...
    print("    python _monitoring_app/monitor/report_generator.py")
    print("    python _monitoring_app/monitor/push_logs.py")
    print("══════════════════════════════════════════════")
    print()
...
def _load_env_monitor():
    ...
    if not env_file.exists():
        ...
        print("  (Copy _monitoring_app/.env.monitor.example → .env.monitor and fill in MONITOR_PUSH_TOKEN")
